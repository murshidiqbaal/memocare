...
/// Reusable SOS Countdown Content
/// Can be used in a Dialog or as a full-screen view
class SOSCountdownContent extends ConsumerWidget {
  final VoidCallback? onCancel;
  final VoidCallback? onClose;

  const SOSCountdownContent({
    super.key,
    this.onCancel,
    this.onClose,
  });
