      ...
      await _notificationsPlugin.zonedSchedule(
        ...
        notificationDetails: NotificationDetails(
          android: AndroidNotificationDetails(
            reminder.alarmEnabled ? 'alarm_channel' : 'reminder_channel',
            reminder.alarmEnabled ? 'Alarm Notifications' : 'Reminder Notifications',
            channelDescription: reminder.alarmEnabled ? 'Full screen alarms' : 'Notifications for medicine and task reminders',
            importance: Importance.max,
            ...
            playSound: true,
            enableVibration: true,
            sound: reminder.alarmEnabled ? const RawResourceAndroidNotificationSound('gentle_tone') : null,
          ),
          iOS: DarwinNotificationDetails(
            presentAlert: true,
            presentBadge: true,
            presentSound: true,
            sound: reminder.alarmEnabled ? 'gentle_tone.mp3' : null,
